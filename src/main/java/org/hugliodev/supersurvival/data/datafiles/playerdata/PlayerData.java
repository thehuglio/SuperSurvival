package org.hugliodev.supersurvival.data.datafiles.playerdata;
...
public class PlayerData implements DataClass {
    private static HashMap<OfflinePlayer,Data> playerDataHashMap = new HashMap<>();
    ...
    public static boolean containsPlayer(Player player) {
        return playerDataHashMap.containsKey(player);
    }
